...
* :data:`STANDARD_RECTANGULAR_DUCT_SIZES`     — EN 1505:2001
...
STANDARD_ROUND_DUCT_SIZES: tuple[int, ...] = (
    63, 80, 100, 125, 150, 160, 200, 250, 300, 315, 355, 400,
    450, 500, 560, 630, 710, 800, 900, 1000, 1120, 1250,
)

# Round branch sizes [d3, d1] -> [d3, d1, d1].
STANDARD_ROUND_BRANCH_SIZES: tuple[tuple[int, int], ...] = (
...
STANDARD_ROUND_TRANSFORMATION_SIZES: tuple[tuple[int, int], ...] = (
    (63, 80), (80, 80), (63, 100), (80, 100),
