...
Math lives in ``wentamojo.physics.friction``; this module is a thin Python
wrapper. The Python import path stays the same.
"""

from __future__ import annotations

from wentamojo.ext.friction_ext import (
...
def friction_factor_colebrook(
    ...
    *,
    ...
    # an issue or call the wentamojo module directly.
