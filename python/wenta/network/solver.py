...
def compute_pressure_drops(
    ...
    """
    from wentamojo.ext.compute_batch_ext import batch_compute
...
def critical_path_pressure_drop(network: Network) -> float:
    ...
    The DP runs in native Mojo via ``wentamojo.ext.solver_ext``. The Python
    ...
    """
    from wentamojo.ext.solver_ext import critical_path_sum
