...
Times every hot wentamojo kernel against its Python equivalent on a
...
from wentamojo.physics.losses import local_pressure_drop, straight_pressure_drop
...
def _bench_friction_factor() raises:
    var py = Python.import_module("wenta.physics.friction")
...
def _bench_local_pressure_drop() raises:
    var py = Python.import_module("wenta.physics.losses")
